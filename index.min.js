...
function fromJson(collection, collectionPath, next) {
    ...
    return last < 1 ? next(null) : docs.forEach(function(docName) {
...
function allCollections(db, name, metadata, parser, next) {
    ...
    return last < 1 ? next(null) : (collections.indexOf(".metadata") >= 0 && (delete collections[collections.indexOf(".metadata")], 
    ...
    function go(root) {
        return my.metadata === !0 && (metadata = root + ".metadata/"), require("mongodb").MongoClient.connect(my.uri, my.options, function(err, db) {
            ...
            db.dropDatabase(function(err) {
                ...
                for (var i = 0, ii = collections.length; i < ii; i++) /^system./.test(collections[i].collectionName) === !1 && my.dropCollections.push(collections[i].collectionName);
...
var fs = require("graceful-fs"), BSON, logger, meta;
